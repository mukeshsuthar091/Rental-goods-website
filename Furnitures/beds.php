        ...
        <div class="product-container">
            ...
            <div class="products-display">
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/products/beds.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Queen Chloe Upholstered Bed with Tufted Headboard & Neutral Color Fabric</h6>
                            <h5 class="p-prize">Rent - 400rs/day</h5>
