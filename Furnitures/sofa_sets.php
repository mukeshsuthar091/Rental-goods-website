    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            <div class="products-category-list">
                ...
                <ul class="pc-list">
                    <a href="sofa_sets.php">
                        <li class="active-li">Sofa Sets</li>
                    </a>
                    <a href="tables.php">
                        <li>Tables</li>
                    </a>
            ...
            <?php
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'sofa' or category = 'sofa set'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/sofa set.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Fabric Sofa Set Torilyn Walnut by Acme Furniture</h6>
