    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            <div class="products-category-list">
                ...
                <ul class="pc-list">
                    ...
                    <a href="dining_table.php">
                        <li class="active-li">Dining Tables</li>
                    </a>
                </ul>
            </div>
            ...
            <?php
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'dining table'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/dining table.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Dining Room Table Seats 12 for Big Family</h6>
                            <h5 class="p-prize">Rent - 500rs/day</h5>
