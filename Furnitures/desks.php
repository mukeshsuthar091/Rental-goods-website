    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            ...
            <div class="products-display">
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'desk'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/desk.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Small Home Desk - Stylish Home Office Desk </h6>
