        ...
        <div class="product-container">
            <div class="products-category-list">
                ...
                <ul class="pc-list">
                    ...
                    <a href="freezers.php">
                        <li class="active-li">Fridges & Freezers</li>
                    </a>
            ...
            <div class="products-display">
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'freezer' OR category = 'fridge'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/fridge.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Fridgemaster 50cm Fridge Freezer</h6>
