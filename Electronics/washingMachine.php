    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            <div class="products-category-list">
                <h4>Electronic Categories</h4>
                <ul class="pc-list">
                    <a href="washingMachine.php">
                        <li class="active-li">Washing Machines</li>
                    </a>
                    <a href="freezers.php">
            ...
            <div class="products-display">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                        <a href="/RentalGoods/show.php?productId=' . $p_id . '&ptitle=' . $p_title . '&pbrand=' . $brandname . '&imageURL=\RentalGoods\img\products\\' . $p_img . '" class="link">
                            <div class="p-card">
                                <div class="image">
                ...
                <!-- <a href="#" class="link" title="LG">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/products/electronics/washing machines/samsung_washing_machine.jpg" alt="LG" title="LG washing machine">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Beko 5Kg Washing Machine</h6>
                            <h5 class="p-prize">Rent - 200rs/day</h5>
