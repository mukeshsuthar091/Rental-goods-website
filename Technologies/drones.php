    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            ...
            <?php
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'drone'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/drone.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">RC S66 Mini Drone with 4K HD Camera, Foldable WiFi FPV Drone</h6>
