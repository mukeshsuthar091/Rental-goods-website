    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            ...
            <?php
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'game'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/Nintendo-Switch-OLED-Neon-Red-Blue.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Nintendo Switch OLED – Neon Red & Blue</h6>
