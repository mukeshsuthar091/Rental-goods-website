    ...
    <section id="electronic-product-category" class="section-p2">
        <div class="product-container">
            ...
            <div class="products-display">
                ...
                $sql = "SELECT * FROM `products` WHERE category = 'tablet'";
                ...
                <!-- <a href="#" class="link">
                    <div class="p-card">
                        <div class="image">
                            <img src="../img/product/Apple-ipad-Air-10.9-Wi-Fi.jpg" alt="">
                        </div>
                        <div class="p-detail">
                            <div class="reting">
                            ...
                            <h6 class="p-name">Apple ipad Air 10.9″ Wi-Fi | Cellular</h6>
                            <h5 class="p-prize">Rent - 350rs/day</h5>
